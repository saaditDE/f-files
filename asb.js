...
{
  /**
   * Called synchronously when about to call ASB.
   *
  ...
  /**
   * Called synchronously when about to return from ASB.
   *
  ...
  onLeave: function(log, retval, state) {
    ...
    if (this.resultId != 1)
    {
    	...
    	log('[*] ASB() Exit'); // needs to be renamed
    }
  }
}
